package io.reist.sandbox.test.repo;
...
public class RepoPresentersTest extends ActivityInstrumentationTestCase2<MainActivity> {

    public RepoPresentersTest() {
    ...
    public static class TestRepoModule extends RepoModule {
