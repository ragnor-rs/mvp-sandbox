...
public class RepoModelTest {
    ...
    @Before
    public void setup() {
        TestComponent modelComponent = DaggerRepoModelTest_TestComponent
                .builder()
    ...
    public interface TestComponent extends SandboxComponent {
        void inject(RepoModelTest baseTest);
    }

    private static class TestRepoModule extends RepoModule {
